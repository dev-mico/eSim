...
if (fightingBack == false) {
	viability = checkViability(creature1, creature2, true); //Pass optional argument, since you are checking the hypothetical (or real) situation where creature2 attacks creature1 and creature1 has to choose whether to fight back.
} else { //If the creature is fighting back, then the other creature's odds to attack the creature are irrelevant. Make the optional argument false
	viability = checkViability(creature1, creature2, true); 
}
