...
if (instance_exists(species) and (is_undefined(parent) == false) and (instance_exists(parent))) { //Failsafe for a bug where the species would be deleted before the egg was spawned
