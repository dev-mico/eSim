...
for (var i = 0; i < buttonCount; i++) {
	...
	draw_text(menu_x, (menu_y + topOffset + (button_h * 2) + (button_h * i)), button[i]); //Draw text with the menu's x, and the menu's Y (incrementing by the button_h), and print the text of each button
}